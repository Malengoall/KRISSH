...
global.channelLink = "https://whatsapp.com/channel/0029VbAYbkdA2pLCiCORBM1t";
global.ytch = "Malengoall";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, { 
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029VbAYbkdA2pLCiCORBM1t' 
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, { 
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/K7C6mBTE9pk7PISS0kpLea?mode=hqrt3` 
                }, { quoted: message });
                return;
            }
        }
